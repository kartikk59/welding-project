...
export default function Navbar() {
  ...
  return (
   ...
   {/* navbar-part */}
    <div className="text-sm text-white w-full fixed top-0 left-0 z-50">
        ...
        {/* upper-bar */}
      <div className="text-center font-medium py-2 bg-gradient-to-r from-violet-500 via-[#9938CA] to-[#E0724A] flex justify-between items-center text-white">
  {/* Left: Location */}
  <a href='https://www.google.com/maps/place/Unit+3%2F90+Colemans+Rd,+Carrum+Downs+VIC+3201,+Australia/@-38.0897588,145.1662496,19z/data=!3m1!4b1!4m6!3m5!1s0x6ad60ce3b7350081:0xba1379acb75f45a6!8m2!3d-38.0897599!4d145.1668933!16s%2Fg%2F11khd33ssq?entry=ttu&g_ep=EgoyMDI1MDcxMy4wIKXMDSoASAFQAw%3D%3D' target='_blank' className="pl-2 md:pl-10 lg:pl-14 xl:pl-10 flex items-center">
    ...
    <span className="ml-2 underline underline-offset-4">Location: 3/90 Colemans rd, Carrum Downs, Victoria [3201]</span>
  </a>

  {/* Right: Social Media Links */}
  <div className="pr-5 flex justify-between gap-4">
    <a href=""><img src="/instagram.png" alt="insta_icon" className='h-5' /></a>
   <a href=''> <img src="/twitter.png" alt="x_icon" className='h-5' /></a>
  </div>
</div>
      ...
      <nav className="relative h-[70px] flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 bg-white text-gray-900 transition-all shadow-sm">
        ...
        <ul className="hidden md:flex items-center space-x-10 md:pl-28">
          <li className='text-extrabold relative text-gray-800 after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full'><a href="#Header">Home</a></li>
          <li className='relative text-gray-800 after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full'><a href="#Services">Our Services</a></li>
          <li className='relative text-gray-800 after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full'><a href="#">Portfolio</a></li>
          <li className='relative text-gray-800 after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full'><a href="#Contact">Contact Us</a></li>
        </ul>

        {/* Desktop Button */}
        <button className="md:inline hidden bg-gradient-to-r from-violet-500 via-[#9938CA] to-[#E0724A] ml-20 px-5 py-2 rounded-md active:scale-95 transition-all text-white cursor-pointer hover:bg-red-600">
          <a href="tel:+12334848">
        ...
        <div className={`mobile-menu absolute top-[70px] left-0 w-full bg-white shadow-sm p-6 ${menuOpen ? '' : 'hidden'} md:hidden`}>
          ...
          <button
            type="button"
            className="bg-gradient-to-r from-violet-500 via-[#9938CA] to-[#E0724A] text-gray-600 border border-white mt-6 text-sm active:scale-95 transition-all w-40 h-11 rounded-full text-white cursor-pointer">
...
<div className="text-left mt-20 px-6 md:px-12 py-20 max-w-2xl">
  ...
  <button className="mt-8 bg-gradient-to-r from-violet-500 via-[#9938CA] to-[#E0724A] text-white font-semibold px-6 py-3 rounded-md flex items-center gap-2 transition-all duration-300 cursor-pointer shadow-[0px_0px_30px_7px_rgba(0,0,0,0.2)]">
