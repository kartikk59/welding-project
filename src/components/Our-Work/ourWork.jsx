  ...
  return (
    <div className='bg-gray-200 pt-10 pb-10'>
        ...
        <>
            ...
            <p className="text-black mb-10 font-poppins text-center text-md">Explore a selection of our recent projects that showcase the precision, durability, and craftsmanship we bring to every weld.</p>
